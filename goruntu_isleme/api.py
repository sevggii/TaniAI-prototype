...
import sys
from pathlib import Path
tani_root = Path(__file__).parent.parent / "TANI"
...
async def tani_diagnose(
    ...
    **Desteklenen Semptomlar:**
    - ates: Ateş
    - kuru_oksuruk: Kuru Öksürük
    - nefes_darligi: Nefes Darlığı
    - koku_kaybi: Koku Kaybı
    - burun_akintisi: Burun Akıntısı
    - hapşirma: Hapşırma
    - goz_kasintisi: Göz Kaşıntısı
    - vb.
    """
    try:
        ...
        logger.error(f"TANI tanı hatası: {str(e)}")
